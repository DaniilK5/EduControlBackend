...
namespace EduControlBackend.Migrations
{
    ...
    [Migration("20250531164018_AddScheduleGradesImagesAndAbsence")]
    partial class AddScheduleGradesImagesAndAbsence
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduControlBackend.Models.CourseModels.Subject", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EduControlBackend.Models.LoginAndReg.User", b =>
                {
                    b.HasOne("EduControlBackend.Models.StudentModels.StudentGroup", "Group")
                        .WithMany("Students")
